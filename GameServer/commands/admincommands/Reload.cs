	...
	public class ReloadCommandHandler : AbstractCommandHandler, ICommandHandler
	{
		...
		public void OnCommand(GameClient client, string[] args)
		{
			...
			if (args[1] == "mob" && args.Length == 1)
			{
				...
				DisplayHeadCmd(client, "reload", "mob", "", 3, false, "AdminCommands.Reload.Syntax.Mob", "AdminCommands.Reload.Usage.Mob");
				return;
			}
					...
					if (args.Length >= 2)
					{
						...
						if (args[2] == "model")
						{
							if (argLength == 2)
							{
								...
								// Syntax: /reload mob model <modelID>
								// Message: Reloads all in-game objects in your current region with the 'GameNPC' type and the model ID specified.
								DisplayHeadCmd(client, "reload", "mob", "model", 3, false, "AdminCommands.Reload.Syntax.ModelMob", "AdminCommands.Reload.Usage.ModelMob");
								return;
							}
							arg = args[3];
						...
						if (args[2] == "name")
						{
							if (argLength == 2)
							{
								...
								// Syntax: /reload mob name <mobName>
								// Message: Reloads all in-game objects in your current region with the 'GameNPC' type and matching the name specified.
								DisplayHeadCmd(client, "reload", "mob", "name", 3, false, "AdminCommands.Reload.Syntax.NameMob", "AdminCommands.Reload.Usage.NameMob");
								return;
							}
						...
						if (args[2] == "realm")
						{
							if (argLength == 2)
							{
								...
								// Syntax: /reload mob realm <realm>
								// Message: Reloads all in-game objects in your current region with the 'GameNPC' type and matching the realm specified.
								DisplayHeadCmd(client, "reload", "mob", "realm", 3, false, "AdminCommands.Reload.Syntax.RealmMob", "AdminCommands.Reload.Usage.RealmMob");
								return;
							}
							...
							else
							{
								...
								// Syntax: /reload mob realm <realm>
								// Message: Reloads all in-game objects in your current region with the 'GameNPC' type and matching the realm specified.
								DisplayHeadCmd(client, "reload", "mob", "realm", 3, false,
					...
					switch (args[2])
					{
						...
						case "model":
						{
							if (argLength == 2)
							{
								...
								// Syntax: /reload object model <modelID>
								// Message: Reloads all in-game objects in your current region with the 'GameStaticItem' type and the model ID specified.
								DisplayHeadCmd(client, "reload", "mob", "model", 3, false, "AdminCommands.Reload.Syntax.ModelObject", "AdminCommands.Reload.Usage.ModelObject");
								return;
							}
							arg = args[3];
						...
						case "name":
						{
							if (argLength == 2)
							{
								...
								// Syntax: /reload object name <objName>
								// Message: Reloads all in-game objects in your current region with the 'GameStaticItem' type and matching the name specified.
								DisplayHeadCmd(client, "reload", "object", "name", 3, false, "AdminCommands.Reload.Syntax.NameObject", "AdminCommands.Reload.Usage.NameObject");
								return;
							}
						...
						case "realm":
						{
							if (argLength == 2)
							{
								...
								// Syntax: /reload mob realm <realm>
								// Message: Reloads all in-game objects in your current region with the 'GameNPC' type and matching the realm specified.
								DisplayHeadCmd(client, "reload", "object", "realm", 3, false, "AdminCommands.Reload.Syntax.RealmMob", "AdminCommands.Reload.Usage.RealmMob");
								return;
							}
