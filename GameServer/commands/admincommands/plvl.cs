				...
				case "single":
				{
					switch (args.Length)
					{
						...
						case 2:
						{
							...
							// Syntax: /plvl single <commandType> <playerName>
							// Message: Grants a character the ability to perform a specific command type regardless of their current privilege level. For '<commandType>', enter only the command identifier (e.g., 'player' for '/player' commands, 'plvl' for '/plvl' commands, etc.).
							DisplayHeadCmd(client, "plvl", "single", "", 3, false, "AdminCommands.Plvl.Syntax.Single", "AdminCommands.Plvl.Usage.Single");
							return;
						}
				...
				case "singleaccount":
				{
					switch (args.Length)
					{
						...
						case 2:
						{
							...
							// Syntax: /plvl singleaccount <commandType> <playerName>
							// Message: Grants all characters on a player's account the ability to perform a specific command type regardless of their current privilege level. For '<commandType>', enter only the command identifier (e.g., 'player' for '/player' commands, 'plvl' for '/plvl' commands, etc.).
							DisplayHeadCmd(client, "plvl", "singleaccount", "", 3, false, "AdminCommands.Plvl.Syntax.AcctSingle", "AdminCommands.Plvl.Usage.AcctSingle");
							return;
						}
				...
				case "remove":
				{
					switch (args.Length)
					{
						...
						case 2:
						{
							...
							DisplayHeadCmd(client, "plvl", "remove", "", 3, false, "AdminCommands.Plvl.Syntax.Remove", "AdminCommands.Plvl.Usage.Remove");
							return;
						}
                ...
                case "removeaccount":
                {
	                switch (args.Length)
					{
						...
						case 2:
						{
							...
							DisplayHeadCmd(client, "plvl", "removeaccount", "", 3, false, "AdminCommands.Plvl.Syntax.AcctRemove", "AdminCommands.Plvl.Usage.AcctRemove");
							return;
						}
				...
				default:
					{
						...
						if (!uint.TryParse(args[1], out plvl))
						{
							...
							DisplayHeadCmd(client, "plvl", "", "", 3, true, "AdminCommands.Plvl.Syntax.Plvl", "AdminCommands.Plvl.Usage.Plvl");
							return;
						}
